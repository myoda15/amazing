...
> **Note for the team:** replace `login1, login2` above with your real 42
> logins, and fill in the names/roles in the *Team & project management*
...
> _Fill this in with your real information._

- **Roles**
  - `login1` — _e.g. maze generation & solver, packaging._
  - `login2` — _e.g. config parsing, rendering, packaging._
- **Planning & how it evolved** — _describe your initial plan and what
  changed along the way._
- **What worked well / what to improve** — _your retrospective._
- **Tools used** — Git, `make`, `flake8`, `mypy`, `build`, and your
  editors of choice.
